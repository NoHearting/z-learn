            ...
            <div class="content-page-wrap">
                ...
                <div id="all-blog-container" class="flat-courses clear-sub-columns clearfix isotope-courses style2">
                    <div class="course style2 one-of-three text-005eea Marketing Design ">
                        <div class="course-border border-f-e6f3ff border-ra4 transition-vline">
                            <div class="course-img img-vline">
                                <a href="/blog/write"><img  src="/images/courses/courses-gird-v2-1.png" alt="写博客"></a>
                                <div class="overlay" >
                            ...
                            <div class="course-content">
                                <div class="text-wrap border-bt-e6f3ff">
                                    <h6 class="title"><a href="/blog/write">写博客</a></h6>
                                    <p class="description">开始创作属于自己的博客吧
                                    </p>
                                </div>
                    ...
                    <div class="course style2 one-of-three text-005eea Marketing Design ">
                        <div class="course-border border-f-e6f3ff border-ra4 transition-vline">
                            <div class="course-img img-vline">
                                <a href="#"><img src="/images/courses/courses-gird-v2-1.png" alt="bookflare"></a>
                                <div class="overlay">
                                    <span class="vline"></span>
                                    <span class="vline vline-bottom"></span>
                                </div>
                            ...
                            <div class="course-content">
                                <div class="text-wrap border-bt-e6f3ff">
                                    <h6 class="title"><a href="/pages/allQuestion">编辑问题</a></h6>
                                    <p class="description">编辑修改已经存在的问题，或者给出答案
                                    </p>
                                </div>
...
<%--<script type="text/javascript" src="/javascript/newAdd/main.js"></script></body>--%>
<script>
    $(function () {
        //动态加载导航栏
        loadHeaderTab();
